                            ...
                            <table class="table table-hover product_item_list c_table theme-color mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-breakpoints="xs">Tags</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><img src="{{ $data->image }}" width="48" alt="Product img"></td>
                                        ...
                                        <td><a href="{{ route('category.show',$data->id) }}" class="btn btn-default waves-effect waves-float btn-sm waves-red">Products</a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
