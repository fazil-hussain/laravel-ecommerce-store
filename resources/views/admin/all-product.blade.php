                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            @if ($data->images->all() ==null)
                                            <img src="public\images\icons\logo-02.png" width="48" alt="Product img"></td>
                                            @else
                                            <img src="{{$data->images->first()->image }}" width="48" alt="Product img"></td>
                                            @endif
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('prodcuct.destroy',$data->id) }}" method="POST" style="display:inline-block">
                                                @csrf
                                                @method('DELETE')
