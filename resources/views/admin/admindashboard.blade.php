...
<body class="theme-blush">
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-view-list"></i><span>Category</span></a>
                    <ul class="ml-menu">
                        <li><a href="{{ route('category.create') }}">Add Category</a></li>
                        <li><a href="{{ route('category.index') }}">All Categories</a></li>
                    </ul>
                </li>
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-view-list"></i><span>Products</span></a>
                    <ul class="ml-menu">
                        <li><a href="{{ route('prodcuct.create') }}">Add Product</a></li>
                        <li><a href="{{ route('prodcuct.index') }}">All Products</a></li>
                        <li><a href="#" onclick="openModal()">Add Color</a></li>
                        <li><a href="{{ route('color.index') }}">All Colors</a></li>
                    </ul>
                </li>
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-notifications-active"></i></i><span>Orders <span style="color: red; font-weight: bold" id="orderspan"></span></span></a>
                    <ul class="ml-menu">
                        <li><a href="{{ route('neworder') }}">New Orders <span style="color: red; font-weight: bold" id="neworderspan">  </span></a></li>
                        <li><a href="{{ route('approvedorders') }}">Approved Orders</a></li>
                        <li><a href="{{route('rejectedorders')}}">Rejected Orders</a></li>
                        <li><a href="{{route('deliverdorders')}}">Deliverid Orders</a></li>
    ...
    <div class="modal fade" id="addcolormodel" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="title" id="defaultModalLabel">Add Color</h4>
                </div>
                <div class="modal-body">
                    <form method="POST" action="{{ route('color.store') }}" id="editcategory" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-danger waves-effect">Add</button>
