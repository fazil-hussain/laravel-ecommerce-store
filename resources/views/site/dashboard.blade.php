...
<div class="sec-banner bg0 p-t-80 p-b-50">
    <div class="container">
        ...
        <div class="row">
            ...
            @foreach (App\Models\Category::offset(0)->limit(3)->get()
            as $category)
            <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                ...
                <div class="block1 wrap-pic-w">
                    ...
                    <a href="{{ route('categoryproducts',$category->id) }}" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
    ...
    <div class="container">
        ...
        <div class="flex-w flex-sb-m p-b-52">
            <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                ...
                @foreach (App\Models\Category::offset(0)->limit(5)->get()
                as $categories)
                <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".cat-{{ $categories->id }}">
                    {{ $categories->name }}
                </button>
                @endforeach
            </div>
        ...
        <div class="row isotope-grid">
            @php
                $pagination=App\models\Product::paginate(8);
            @endphp
            @foreach ($pagination as $pro)
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item cat-{{ $pro->category_id }} " id="allpro">
                <!-- Block2 -->
                <div class="block2">
        ...
        $('.quickviewbtn').click(function() {
            ...
            $.ajax({
                ...
                , success: function(response) {
                    ...
                    $('#m-pro-price').text('$ ' + response.product.price);
